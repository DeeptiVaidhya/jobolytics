...
$route['besafe'] = 'home/besafe';

$route['security_center'] = 'home/security_center';
...
$route['subscribe_email'] = 'home/subscribe_email';

$route['send_feedback'] = 'home/send_feedback';

$route['upload/crop'] = "crop/upload";

$route['resume-builder-strategy'] = 'resume/resume_builder_strategy';
