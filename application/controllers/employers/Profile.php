...
class Profile extends CI_Controller{
	...
	{		
		...
		if ($this->input->post('update'))
		{
			...
			$this->form_validation->set_rules('emp_img','emp img','trim');
			...
			else
			{
				...
				if (!empty($_FILES["emp_img"]['name'])) {
	                ...
	                $config['upload_path']          =  'uploads/emp_img';
	                ...
	                if (!$this->upload->do_upload('emp_img')) {
	                    ...
	                    $data['emp_img'] =  'uploads/emp_img/'. $file_data['upload_data']['file_name'];
	                }
		        }

				else{
					$data['emp_img'] = $this->input->post('emp_img');
				}
