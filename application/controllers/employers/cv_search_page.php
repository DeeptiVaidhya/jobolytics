				...
				<div class="search-bar">
	                ...
	                <div class="row justify-content-center form-wrap no-gutters">
	                  <div class="col-lg-6 form-cols">
	                    <input type="text" class="form-control" name="job_title" value="<?php if(isset($search_value['job_title'])) echo str_replace('-', ' ', $search_value['job_title']); ?>" placeholder="what are you looking for?">
	                  </div>
