...
<html lang="en">
    <head>
          <title><?=isset($title)?$title:'Registration - FedCon' ?></title>
                    ...
                    <div class="form-box">
                        ...
                        <?php echo form_open(base_url('admin/auth/register'), 'class="login-form" '); ?>
                            <div class="input-group">
                                ...
                                <p class="text-center"><a href="<?= base_url('admin/auth/login'); ?>">You already have a account?</a></p>
                            </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
