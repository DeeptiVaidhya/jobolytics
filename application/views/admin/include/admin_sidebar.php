     ...
     <!--  <ul class="sidebar-menu">
      ...
      <ul class="sidebar-menu">
        <li id="city" class="treeview">
            <a href="#">
              <i class="fa fa-location-arrow "></i> <span>Resume Request</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class=""><a href="<?= base_url('admin/Resume_request'); ?>"><i class="fa fa-circle-o"></i>Pending</a></li>
              <li class=""><a href="<?= base_url('admin/Resume_request/inprogress'); ?>"><i class="fa fa-circle-o"></i>Inprogress</a></li>
              <li class=""><a href="<?= base_url('admin/Resume_request/complete'); ?>"><i class="fa fa-circle-o"></i>Complete</a></li>
               <li class=""><a href="<?= base_url('admin/Resume_request/cancel'); ?>"><i class="fa fa-circle-o"></i>Cancel</a></li>
            </ul>
          </li>
      </ul>
        ...
        <ul class="sidebar-menu">
        <li id="category" class="treeview">
              <a href="<?php echo base_url('admin/Coupon/coupon_managment');?>">
