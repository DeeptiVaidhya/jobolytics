   ...
   <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-list"></i> &nbsp; Cancle Request </h4>
        </div>
      ...
      <table id="example1" class="table table-bordered table-striped ">
        ...
        <tbody>
          ...
          <a href="<?php echo base_url(); ?>admin/Resume_request/Process/<?php echo $row['r_id']; ?>"> <button class="btn btn-success btn-sm" style="background-color: #03A9F4;border-color: #46b8da;">IN PROCESS</button></a>
            ...
            <a title="Delete" class="delete btn btn-sm btn-danger pull-right" href="<?php echo base_url(); ?>admin/Resume_request/delete_request/<?php echo $row['r_id']; ?>" > <i class="fa fa-trash-o"></i></a>
          </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
