   ...
   <div class="row">
    ...
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-list"></i> &nbsp; Inprogress Request </h4>
        </div>
    ...
    <div class="box-body">
      <table id="example1" class="table table-bordered table-striped ">
        ...
        <tbody>
            ...
            <td>
              <?php
                if ($row['status'] == 0) {
                  ...
                  echo "<p style='color:#3c8dbc;font-size: 14px;font-weight: 600;'>INPROCESS</p>";
                }
          ...
          <a href="<?php echo base_url(); ?>admin/Resume_request/move_complete/<?php echo $row['r_id']; ?>"> <button class="btn btn-success btn-sm" >COMPLETE</button></a>
