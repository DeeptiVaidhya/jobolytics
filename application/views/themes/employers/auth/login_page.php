    ...
    <div class="wrap-login100">
      ...
      <?php $attributes = array('id' => 'login_form', 'method' => 'post' , 'class' => 'login100-form validate-form');
        ...
        <div class="container-login100-form-btn pt-4">
          <input type="submit" class="login100-form-btn" name="login" value="LogIn" style="background: #bd2025 !important">
        </div>
      <?php echo form_close(); ?>

      <div class="text-center w-full pt-4">
          <a class="txt1 bo1 hov1" href="<?= base_url(); ?>employers/auth/forgot_password" style="color: #bd2025;border-bottom: 1px solid #bd2025;">
            Forgot Password?            
          </a>
      </div>
      <div class="text-center w-full pt-3">
          ...
          <a class="txt1 bo1 hov1" href="<?= base_url(); ?>employers/auth/registration" style="color: #bd2025;border-bottom: 1px solid #bd2025;">
            Sign up now             
          </a>
      </div>
    </div>
