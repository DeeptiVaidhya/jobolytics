      ...
      <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav"><a href="<?= base_url(); ?>">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> Applied Jobs</a></p>
          </div>                      
        </div>
      </div>
    </section>
				...
				<div class="single-post d-flex flex-row">
					...
					<div class="job-listing-btns ml-4">
						<ul class="btns">
							...
							<li>
								<a href="<?php echo site_url('Myjobs/deleteMyaplication/')?><?php echo $job['del_id']; ?>">
