            ...
            <div class="projectAdd" id="projectAdd">\
              <div class="col-md-12">\
                <div class="form-group">\
                  ...
                  <input type="text" class="form-control formbox" id="proj" name="company['+count+'][0][project]" placeholder="Project title" required>\
                </div>\
              </div>\
              <div class="col-md-12">\
                <div class="form-group">\
                  <label for="cpwd"></label>\
                  <textarea class="form-control formbox" id="desp2" name="company['+count+'][0][project_description]" placeholder="Description" cols="2" rows="2" required></textarea>\
                </div>\
              </div>\
              <div class="col-md-12">\
                <div class="form-group">\
                  <label for="cpwd"></label>\
                  <input type="text" class="form-control formbox" id="url" name="company['+count+'][0][project_url]" placeholder="URL" required>\
                </div>\
              </div>\
            </div>\
			...
			.append('<div class="projectAdd_innerBox">\
					<div class="col-md-12">\
						<div class="form-group">\
							<label for="Projects"> Projects</label>\
							<a href="javascript:void(0);" class="float-right formbox1 remove_add_project"><i class="fa fa-minus" aria-hidden="true"></i></a>\
							<input type="text" class="form-control formbox" id="proj" name="company['+count+'][' + counter_project + '][project]" placeholder="Project title" required>\
						</div>\
					</div>\
					<div class="col-md-12">\
						<div class="form-group">\
							<label for="cpwd"></label>\
							<textarea class="form-control formbox" id="desp2" name="company['+count+'][' + counter_project + '][project_description]" placeholder="Description" cols="2" rows="2" required></textarea>\
						</div>\
					</div>\
					<div class="col-md-12">\
						<div class="form-group">\
							<label for="cpwd"></label>\
							<input type="text" class="form-control formbox" id="url" name="company['+count+'][' + counter_project + '][project_url]" placeholder="URL" required>\
						</div>\
					</div>\
				</div>')
	});
			...
			.append('<div class="degreeAdd" id="degreeAdd">\
						<div class="col-md-12">\
							<div class="form-group">\
								...
								<input type="text" class="form-control formbox" id="degree_name" name="degree[0][' + counter_degree + '][name]"" placeholder="Enter your Degree" autocomplete="my-field-name">\
						...
						<div class="col-md-12">\
							<div class="form-group">\
								...
								<input type="text" class="form-control formbox" id="specialization" name="degree[0][' + counter_degree + '][specialization]" placeholder="Enter your specialization" autocomplete="my-field-name">\
						...
						<div class="col-md-12">\
							<div class="form-group">\
								...
								<input type="date" class="form-control formbox" id="year_of_admission" name="degree[0][' + counter_degree + '][year_of_admission]" placeholder="Enter your Admission Year" autocomplete="my-field-name">\
						...
						<div class="col-md-12">\
							<div class="form-group">\
								...
								<input type="date" class="form-control formbox" id="year_of_passing_error" name="degree[0][' + counter_degree + '][year_of_passing]" placeholder="Enter your Passing Year" autocomplete="my-field-name">\
			...
			.append('<div class="certificateAdd" id="certificateAdd">\
              <div class="col-md-12">\
                <div class="form-group">\
                  ...
                  <input type="text" class="form-control formbox" id="certificate_name" name="certificate[0]['+counter_certificate+'][name]" placeholder="Enter your Ceritificate" autocomplete="my-field-name">\
              ...
              <div class="col-md-12">\
                <div class="form-group">\
                  <label for="pwd">Year of Admission</label>\
                  <input type="date" class="form-control formbox" id="year_of_certificate" name="certificate[0]['+counter_certificate+'][year_of_certificate]" placeholder="Enter Certificate Date" autocomplete="my-field-name">\
